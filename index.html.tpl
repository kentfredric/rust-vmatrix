...
# *empty file*
  ...
  <h1 id="contributing">Contributing<a href="#contributing">&#x2693;</a></h1>
    ...
    <p>Just be aware, at the <span class="hint"
      title="#[projection_at]">time of this writing</span> there
      is a <strong>sizeable</strong> backlog of
      <em>#[projection_crates] crates</em> amassing
      <em>#[projection_targets] build
      combinations</em> which works out at a cool range of between
      <em>#[projection_est_low]</em> and
      <em>#[projection_est_high]</em> of build time queued.</p>
